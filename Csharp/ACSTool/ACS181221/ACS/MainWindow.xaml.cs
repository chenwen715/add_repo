...
namespace ACS
{
    ...
    public partial class MainWindow : Window
    {
        ...
        private void MItem_DisplayPath_Click(object sender, RoutedEventArgs e)
        {
            ...
            //Agv agv = DGrid_ExecUnit.SelectedItem as Agv;
            //if (agv.sTaskList.Count <= 0) return;
    ...
    public class AgvStatusConvert : IValueConverter
    {
        public object Convert(object value, Type targetType, object parameter, System.Globalization.CultureInfo culture)
        {
            ...
            else if (value.ToString() == "Middle")
            {
                return "中位";
            }
            else if (value.ToString() == "High")
            {
                return "高位";
            }
            else if (value.ToString() == "D10")
            {
                return "自动、无码";
            }
            else if (value.ToString() == "D11")
            {
                return "自动、空闲";
            }
            else if (value.ToString() == "D12")
            {
                return "自动、歪码";
            }
            else if (value.ToString() == "D13")
            {
                return "忙碌";
            }
            else if (value.ToString() == "D14")
            {
                return "充电中";
            }
            else if (value.ToString() == "D15")
            {
                return "充电完成";
            }
            else if (value.ToString() == "D20")
            {
                return "手动、无码";
            }
            else if (value.ToString() == "D21")
            {
                return "手动、有码";
            }
